...
class MessageRepositoryImpl @Inject constructor(private val service: MessageService, private val userService: UserService) :
    ...
    override suspend fun sendMessage(userId: String?, chatRequestDto: ChatRequestDto) =
        service.sendNewChat(userId, chatRequestDto)

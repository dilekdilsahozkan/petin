...
class CurvedBottomNavigationView @JvmOverloads constructor(
    ...
    init {
        ...
        with(mPaint) {
            ...
            color = Color.parseColor("#2A2C41")
            strokeWidth = 1f
        }
        mPaint.setShadowLayer(6f, 2f, 2f, context.getColor(R.color.secondaryColor));
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        mFirstCurveStartPoint.set(mNavigationBarWidth / 2 - radius * 2 - radius / 3, 2)
        // the coordinates (x,y) of the end point after curve
        mFirstCurveEndPoint.set(mNavigationBarWidth / 2, radius + radius / 4)
        // same thing for the second curve
        mSecondCurveStartPoint = mFirstCurveEndPoint
        mSecondCurveEndPoint.set(mNavigationBarWidth / 2 + radius * 2 + radius / 3, 2)
        ...
        mPath.apply {
            ...
            lineTo(mNavigationBarWidth.toFloat(), 2f)

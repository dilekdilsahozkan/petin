...
class PostRepositoryImpl @Inject constructor(private val service: FeedService) :
    ...
    override suspend fun getFeed(searchQuery: String?, index: Int?, size: Int?, dateTime: Long?, postType: Int?) = service.getFeed(searchQuery, index, size, dateTime, postType)
